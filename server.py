...
INVENTORY_TEMPLATE = {
    InventoryCategory.BOTIQUIN_TRAUMA: [
        ...
        {"name": "Punzocat #14, #16, #18", "expected": 2},
        {"name": "Punzocat #20, #22, #24", "expected": 2},
        ...
        {"name": "Jeringas 3ml, 5ml, 10ml, 20ml", "expected": 3},
    ...
    InventoryCategory.BOTIQUIN_VIA_AEREA: [
        ...
        {"name": "Cánulas orofaríngeas", "expected": 6},
        {"name": "Abatelenguas", "expected": 5},
    ...
    InventoryCategory.RACK: [
        ...
        {"name": "Jeringas 1ml, 3ml, 5ml, 10ml, 20ml", "expected": 3},
        {"name": "Pañales / protectores", "expected": 2},
        {"name": "Bolsas RPBI roja", "expected": 3},
        {"name": "Contenedor RPBI rígido", "expected": 1},
        {"name": "Equipo de venoclisis", "expected": 2},
        {"name": "Ligadura (torniquete)", "expected": 1},
        {"name": "Punzocat #14, #16, #18, #20, #22, #24", "expected": 2},
        ...
        {"name": "Venda elástica 5cm, 10cm, 15cm, 30cm", "expected": 2},
    ...
    InventoryCategory.EQUIPO_PORTATIL: [
        ...
        {"name": "Monitor de signos vitales", "expected": 1, "is_critical": True},
